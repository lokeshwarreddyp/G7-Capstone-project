package com.wipro.springboot.security;
...
import com.wipro.springboot.security.JWT.JwtEntryPoint;
import com.wipro.springboot.security.JWT.JwtFilter;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable().authorizeRequests()
				...
				.antMatchers("/order/finish/**").access("hasAnyRole('MANAGER')").antMatchers("/order/**")
				...
				.antMatchers("/seller/**").access("hasAnyRole('MANAGER')").anyRequest().permitAll()
